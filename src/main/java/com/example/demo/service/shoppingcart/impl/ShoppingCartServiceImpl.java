...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public ShoppingCartResponseDto addCartItemToShoppingCart(CartItemRequestDto cartItemRequestDto,
                                                             User user) {
        Book book = bookMapper.dtoToModel(bookService.getBookById(cartItemRequestDto.getBookId()));
    ...
    @Override
    public void deleteCartItemInShoppingCart(ShoppingCart shoppingCart,
                                             CartItem cartItem) {
        Set<CartItem> cartItems = shoppingCart.getCartItems();
    ...
    @Override
    public void updateShoppingCartForUser(User user) {
